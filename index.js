...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5511948040302@s.whatsapp.net"] // replace this with your number
...
case 'textodeneve':
				...
				case 'wait':
					...
					break
                                					case 'dono':
if (args.length < 1) return reply('TrashфDkofcꪶ Número do meu dono😎🤙:WA.me/5511948040302\n😎🤙Youtube do meu \ndono:https://youtube.com/channel/UCOqlFzRrB8IZUWUx1cwCeUw\n \nNúmero da cremosa do meu dono que ajudou a fazer o menu 😎🤙ঔৣ☬✞𝐓𝐫𝐚𝐬𝐡|𝐉𝐮𝐰 ✞☬ঔৣ: wa.me/5511948040302')
                                        break
case 'porno':
